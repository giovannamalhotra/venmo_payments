...
<br/>
        ><i>Note: Due to time constraint and the submission deadline, improvements made after the deadline will be implemented here: https://github.com/giovannamalhotra/venmo_payments_v2.</i>
